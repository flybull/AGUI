...
function sc_gui_config_attr_parse_syn_default(__self)
{
	...
	sc_gui_config_set_attr_parse(__self, "cid", sc_base_empty_call);
...
/// @function:		sc_gui_config_set_attr_parse(__self, __name, __function) 
...
/// @function:		sc_gui_config_get_attr_parse(__self, __name) 
...
function sc_gui_config_set_attr_parse_private(__self)
{
	sc_gui_config_set_attr_parse(__self, "private", function(__attr, __name, __realname, __self) {
...
function sc_gui_config_set_attr_parse_xy(__self)
{
	sc_gui_config_set_attr_parse(__self, "x", function(__attr, __name, __realname, __self) {
		block_x = variable_struct_get(__attr, __name);
	});
	sc_gui_config_set_attr_parse(__self, "y", function(__attr, __name, __realname, __self) {
...
function sc_gui_config_set_attr_parse_margin(__self)
{
	sc_gui_config_set_attr_parse(__self, "margin", function(__attr, __name, __realname, __self) {
	...
	sc_gui_config_set_attr_parse(__self, "mt", function(__attr, __name, __realname, __self) {
		margin_top = variable_struct_get(__attr, __name);
	});
	sc_gui_config_set_attr_parse(__self, "mb", function(__attr, __name, __realname, __self) {
		margin_bottom = variable_struct_get(__attr, __name);
	});
	sc_gui_config_set_attr_parse(__self, "ml", function(__attr, __name, __realname, __self) {
		margin_left = variable_struct_get(__attr, __name);
	});
	sc_gui_config_set_attr_parse(__self, "mr", function(__attr, __name, __realname, __self) {
...
function sc_gui_config_set_attr_parse_padding(__self)
{
	sc_gui_config_set_attr_parse(__self, "padding", function(__attr, __name, __realname, __self) {
		var _val = variable_struct_get(__attr, __name);
		if (is_array(_val)) {
			switch(array_length(_val)) {
			default:
	...
	sc_gui_config_set_attr_parse(__self, "pt", function(__attr, __name, __realname, __self) {
		padding_top = variable_struct_get(__attr, __name);
	});
	sc_gui_config_set_attr_parse(__self, "pb", function(__attr, __name, __realname, __self) {
		padding_bottom = variable_struct_get(__attr, __name);
	});
	sc_gui_config_set_attr_parse(__self, "pl", function(__attr, __name, __realname, __self) {
		padding_left = variable_struct_get(__attr, __name);
	});
	sc_gui_config_set_attr_parse(__self, "pr", function(__attr, __name, __realname, __self) {
...
function sc_gui_config_set_attr_parse_flex(__self)
{
	sc_gui_config_set_attr_parse(__self, "flex_algin", function(__attr, __name, __realname, __self) {
	...
	sc_gui_config_set_attr_parse(__self, "flex_justify", function(__attr, __name, __realname, __self) {
...
function sc_gui_config_set_attr_parse_block(__self)
{
	sc_gui_config_set_attr_parse(__self, "bd", function(__attr, __name, __realname, __self) {
	...
	sc_gui_config_set_attr_parse(__self, "w", function(__attr, __name, __realname, __self) {
		spec_width = variable_struct_get(__attr, __name);
	});
	sc_gui_config_set_attr_parse(__self, "h", function(__attr, __name, __realname, __self) {
		spec_height = variable_struct_get(__attr, __name);
	});
	sc_gui_config_set_attr_parse(__self, "max_w", function(__attr, __name, __realname, __self) {
		max_width = variable_struct_get(__attr, __name);
	});
	sc_gui_config_set_attr_parse(__self, "max_h", function(__attr, __name, __realname, __self) {
...
function sc_gui_config_set_attr_parse_shape(__self)
{
	sc_gui_config_set_attr_parse(__self, "attr_shape", function(__attr, __name, __realname, __self) {
...
function sc_gui_config_set_attr_parse_func(__self)
{
	sc_gui_config_set_attr_parse(__self, "func", function(__attr, __name, __realname, __self) {
	...
	sc_gui_config_set_attr_parse(__self, "func_check_hover", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.CHECK_HOVER] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_check_hover_scale", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.CHECK_HOVER_SCALE] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_check_hover_scroll", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.CHECK_HOVER_SCROLL] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_check_hover_childs", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.CHECK_HOVER_CHILDS] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_check_press", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.CHECK_PRESS] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_check_release", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.CHECK_RELEASE] = method(undefined, _func);
	});

	sc_gui_config_set_attr_parse(__self, "func_on_hover", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_HOVER] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_on_away", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_AWAY] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_on_focus", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_FOCUS] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_on_blur", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_BLUR] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_on_press", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_PRESS] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_on_hold", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_HOLD] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_on_release", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_RELEASE] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_on_input", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_INPUT] = method(undefined, _func);
	});

	sc_gui_config_set_attr_parse(__self, "func_on_move", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_MOVE] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_on_scroll", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_SCROLL] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_on_scale", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_SCALE] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_on_drag", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_DRAG] = method(undefined, _func);
	});
	
	sc_gui_config_set_attr_parse(__self, "func_on_begin", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_INIT_BEGIN] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_on_end", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_INIT_END] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_on_ready", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_INIT_READY] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_on_destroy", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_DESTORY] = method(undefined, _func);
	});

	sc_gui_config_set_attr_parse(__self, "func_on_update", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_UPDATE] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_on_step", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_STEP] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_on_draw", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.ON_DRAW] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_draw_backward", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.DRAW_BACKWARD] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_draw_forward", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.DRAW_FORWARD] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_draw_border", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.DRAW_BORDER] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_draw_background", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.DRAW_BACKGROUND] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_draw_grids", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.DRAW_GRIDS] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_draw_childs", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.DRAW_CHILDS] = method(undefined, _func);
	},);
	sc_gui_config_set_attr_parse(__self, "func_draw_decorate", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.DRAW_DECORATE] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_data_get", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
		func[@ GUI_FUNC_TYPE.DATA_GET] = method(undefined, _func);
	});
	sc_gui_config_set_attr_parse(__self, "func_data_set", function(__attr, __name, __realname, __self) {
		var _func = variable_struct_get(__attr, __name);
...
function sc_gui_config_set_attr_parse_struct(__self, __names)
{
	if (is_array(__names)) {
		for (var i = 0; i < array_length(__names); ++i) {
			sc_gui_config_set_attr_parse(__self, __names[i], function(__attr, __name, __realname, __self) {
				variable_struct_set(self, is_undefined(__realname) ? __name : __realname, variable_struct_get(__attr, __name));
			});
		}
	} else {
		sc_gui_config_set_attr_parse(__self, __names, function(__attr, __name, __realname, __self) {
			variable_struct_set(self, is_undefined(__realname) ? __name : __realname, variable_struct_get(__attr, __name));
		});
	}
}
...
function sc_gui_config_set_attr_parse_decorate_template(__self, __name, __function)
{
	...
	sc_gui_config_set_attr_parse(__self, 
...
function sc_gui_config_set_attr_parse_animation(__self)
{
	sc_gui_config_set_attr_parse(__self, "animation", function(__attr, __name, __realname, __self) {
...
{
	sc_gui_config_set_attr_parse(__self, "observer", function(__attr, __name, __realname, __self) {
		var _values = variable_struct_get(__attr, __name);
		// any | someone
